...
.DESCRIPTION
  ...
  this workspace looks like before the first patch exists. The script says so and exits 0 WITHOUT
  requiring the Spriggit CLI or 7-Zip, so CI stays green from the first commit.
