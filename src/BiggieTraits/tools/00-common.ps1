# Shared helpers for the Biggie Traits -> Enderal conversion generators.
#
...
$script:EspRoot = Join-Path (Split-Path -Parent $PSScriptRoot) 'BiggieTraitsESP'
