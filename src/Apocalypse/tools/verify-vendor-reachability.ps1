...
#   4. The 160 tomes are covered exactly once each.
...
if ($total -ne 160) { throw "$total tomes stocked, expected 160" }
...
"proof: $total/160 tomes stocked across $($hooks.Count) UseAll hooks, each exactly once, all priced"
